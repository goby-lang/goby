...
const (
	vmPkg     = "github.com/gooby-lang/gooby/vm"
	errorsPkg = "github.com/gooby-lang/gooby/vm/errors"
)
...
// Binding holds context about a struct that represents a gooby class.
type Binding struct {
	ClassName       string
...
func (b *Binding) topCommentBlock() Code {
	return Add(
		...
		Line(),
		Commentf("This code has been generated by github.com/gooby-lang/gooby/cmd/binder"),
		Line(),
	)
...
// BindMethods generates code that binds methods of a go structure to a gooby class
...
// This function will be bound to a spesific instantation of a gooby class.
