...
var builtinCommonInstanceMethods = []*BuiltInMethodObject{
	{
		...
		// @return True/False [Boolean] Result of loading module
		Name: "require",
		Fn: func(receiver Object) builtinMethodBody {
			return func(t *thread, args []Object, blockFrame *callFrame) Object {
...
var builtinClassClassMethods = []*BuiltInMethodObject{
	...
	{
		// Creates instance variables and corresponding methods that return the value of each instance variable and assign an argument to each instance variable.
		// Only string literal can be used for now.
		//
		//```ruby
		//class Foo
	...
	},
	{
		...
		//class Baz
		//  include(Foo)
		//  include(Bar) # prioritized for `ten`
		//end
		//
		//a = Baz.new
	...
	},
	{
		...
		// @return object [Object] Created object
		Name: "new",
		Fn: func(receiver Object) builtinMethodBody {
			return func(t *thread, args []Object, blockFrame *callFrame) Object {
				class := receiver.(*RClass)
	...
	},
	{
		...
		// ```
		// @param class [Class] Receiver
		// @return name [String] Converted receiver name
		Name: "name",
		Fn: func(receiver Object) builtinMethodBody {
			return func(t *thread, args []Object, blockFrame *callFrame) Object {
	...
	},
	{
		...
		//```
		// @param class [Class] Receiver
		// @return object [object] Superclass object of the receiver
		Name: "superclass",
		Fn: func(receiver Object) builtinMethodBody {
			return func(t *thread, args []Object, blockFrame *callFrame) Object {
