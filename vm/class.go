		...
		},
		{
			...
			Fn: func(receiver Object, instruction *instruction) builtinMethodBody {
				return func(t *thread, args []Object, blockFrame *normalCallFrame) Object {
					...
					if !ok {
						return t.vm.initErrorObject(errors.TypeError, instruction.sourceLine, "Expect argument to be a module. got=%v", args[0].Class().Name)
					}
		...
		},
		{
			...
			Fn: func(receiver Object, instruction *instruction) builtinMethodBody {
				return func(t *thread, args []Object, blockFrame *normalCallFrame) Object {
					...
					if !ok {
						return t.vm.initErrorObject(errors.UndefinedMethodError, instruction.sourceLine, "Undefined Method '%s' for %s", "#name", receiver.toString())
					}
		...
		},
		{
			...
			Fn: func(receiver Object, instruction *instruction) builtinMethodBody {
				return func(t *thread, args []Object, blockFrame *normalCallFrame) Object {
					...
					if !ok {
						return t.vm.initErrorObject(errors.UndefinedMethodError, instruction.sourceLine, "Undefined Method '%s' for %s", "#superclass", receiver.toString())
					}
		...
		},
		{
			...
			Fn: func(receiver Object, instruction *instruction) builtinMethodBody {
				return func(t *thread, args []Object, blockFrame *normalCallFrame) Object {
					...
					if !ok {
						return t.vm.initErrorObject(errors.UndefinedMethodError, instruction.sourceLine, "Undefined Method '%s' for %s", "#ancestors", receiver.toString())
					}
	...
	return []*BuiltinMethodObject{
		...
		},
		{
			...
			Fn: func(receiver Object, instruction *instruction) builtinMethodBody {
				return func(t *thread, args []Object, blockFrame *normalCallFrame) Object {
					...
					if !ok {
						return t.vm.initErrorObject(errors.InternalError, instruction.sourceLine, "Can't require \"%s\"", libName)
					}
		...
		},
		{
			...
			Fn: func(receiver Object, instruction *instruction) builtinMethodBody {
				return func(t *thread, args []Object, blockFrame *normalCallFrame) Object {
					if len(args) < 1 {
						return t.vm.initErrorObject(errors.ArgumentError, instruction.sourceLine, "no method name given")
					}
		...
		},
		{
			...
			Fn: func(receiver Object, instruction *instruction) builtinMethodBody {
				return func(t *thread, args []Object, blockFrame *normalCallFrame) Object {
					...
					if !ok {
						return t.vm.initErrorObject(errors.TypeError, instruction.sourceLine, errors.WrongArgumentTypeFormat, classes.ClassClass, c.Class().Name)
					}
