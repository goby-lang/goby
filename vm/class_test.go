...
func TestGeneralIsAMethod(t *testing.T) {
	tests := []struct {
		...
		{`{ a: 1, b: "2", c: ["Gooby", 123] }.is_a?(Hash)`, true},
		{`{ a: 1, b: "2", c: ["Gooby", 123] }.is_a?(Object)`, true},
		{`{ a: 1, b: "2", c: ["Gooby", 123] }.is_a?(Class)`, false},
		{`{ a: 1, b: "2", c: ["Gooby", 123] }.is_a?(Array)`, false},
