...
func TestDecimalTruncation(t *testing.T) {
	tests := []struct {
		...
		{`["9.0".to_d][0].to_s`, "9.0"},
		{`["9.00".to_d][0].to_s`, "9.0"},
		{`["1.0".to_d][0].to_s`, "1.0"},
		{`["1.00".to_d][0].to_s`, "1.0"},
		{`["0.0".to_d][0].to_s`, "0.0"},
		{`["0.00".to_d][0].to_s`, "0.0"},
...
func TestDecimalNumberOfDigit(t *testing.T) {
	tests := []struct {
		...
		{`"3.1415926535897932".to_d.to_s`, "3.141592653589793"},
		{`"3.1415926535897932384626".to_d.to_s`, "3.141592653589793"},
		{`"-3.14".to_d.to_s`, "-3.14"},
		{`"-3.141".to_d.to_s`, "-3.141"},
		{`"-3.1415".to_d.to_s`, "-3.1415"},
		{`"-3.14159".to_d.to_s`, "-3.14159"},
...
func TestDecimalMinusZero(t *testing.T) {
	tests := []struct {
		...
		{`"0.0".to_d.to_s`, "0.0"},
		{`""-0.0".to_d.to_s`, "-0.0"},
		{`"(-0.0 == 0.0)".to_d.to_s`, "true"},
		{`"(0.0 + 0.0)".to_d.to_s`, "0.0"},
		{`(0.0 + -0.0)".to_d.to_s`, "0.0"},
		{`"(0.0 - 0.0)".to_d.to_s`, "0.0"},
		{`"(0.0 - -0.0)".to_d.to_s`, "0.0"},
		{`"(-0.0 + 0.0)".to_d.to_s`, "0.0"},
