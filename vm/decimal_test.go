...
func TestDecimalArithmeticOperationWithFloat(t *testing.T) {
	tests := []struct {
		...
		{`('16.1'.to_d  ** "1.1".to_d).to_s`, "21.257317715840923000314433011226356029510498046875"},
		{`('16.1'.to_d  ** "1.1".to_f).to_s`, "21.257317715840923000314433011226356029510498046875"},
	}
