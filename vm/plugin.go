	...
	return []*BuiltinMethodObject{
		{
			...
			Fn: func(receiver Object, instruction *instruction) builtinMethodBody {
				return func(t *thread, args []Object, blockFrame *normalCallFrame) Object {
					...
					if !ok {
						return t.vm.initErrorObject(errors.TypeError, instruction.sourceLine, errors.WrongArgumentTypeFormat, "String", args[0].Class().Name)
					}
	...
	return []*BuiltinMethodObject{
		{
			...
			Fn: func(receiver Object, instruction *instruction) builtinMethodBody {
				return func(t *thread, args []Object, blockFrame *normalCallFrame) Object {
					...
					if err != nil {
						return t.vm.initErrorObject(errors.InternalError, instruction.sourceLine, "Error when creating plugin: %s", err.Error())
					}
					...
					if err != nil {
						t.vm.initErrorObject(errors.InternalError, instruction.sourceLine, err.Error())
					}
