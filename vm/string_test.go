...
func TestStringFmtMethodFail(t *testing.T) {
	testsFail := []errorTestCase{
		{`String.fmt()`, "ArgumentError: Expect 1 or more argument(s). got: 0", 1, 1},
		{`String.fmt(1)`, "TypeError: Expect argument to be String. got: Integer", 1, 1},
		{`String.fmt("Hello! %s Lang!")`, "ArgumentError: Expect 1 additional string(s) to insert. got: 0", 1, 1},
		{`String.fmt("Hello! %s Lang!", "Goby", "Ruby")`, "ArgumentError: Expect 1 additional string(s) to insert. got: 2", 1, 1},
	}
...
func TestMatchMethodFail(t *testing.T) {
	testsFail := []errorTestCase{
		{`"abc".match?(*[1, 2])`, "ArgumentError: Expect 1 argument(s). got: 2", 1, 1},
		{`"abc".match?('a')`, "TypeError: Expect argument to be Regexp. got: String", 1, 1},
	}
	for i, tt := range testsFail {
		v := initTestVM()
		evaluated := v.testEval(t, tt.input, getFilename())
...
func TestStringOperationFail(t *testing.T) {
	testsFail := []errorTestCase{
		...
		{`"Taipei" * (-101)`, "ArgumentError: Expect second argument to be positive value. got: -101", 1, 1},
		...
		{`"Taipei"[]`, "ArgumentError: Expect 1 argument(s). got: 0", 1, 1},
		{`"Taipei"[true] = 101`, "TypeError: Expect argument to be Integer. got: Boolean", 1, 1},
		{`"Taipei"[20] = "10"`, "ArgumentError: Index value out of range. got: 20", 1, 1},
		{`"Taipei"[-20] = "a"`, "ArgumentError: Index value out of range. got: -20", 1, 1},
	}
...
func TestStringConcatenateMethodFail(t *testing.T) {
	testsFail := []errorTestCase{
		{`"a".concat`, "ArgumentError: Expect 1 argument(s). got: 0", 1, 1},
		{`"a".concat("Hello", "World")`, "ArgumentError: Expect 1 argument(s). got: 2", 1, 1},
...
func TestStringDeleteMethodFail(t *testing.T) {
	testsFail := []errorTestCase{
		{`"Hello hello HeLlo".delete`, "ArgumentError: Expect 1 argument(s). got: 0", 1, 1},
...
func TestStringEndWithMethodFail(t *testing.T) {
	testsFail := []errorTestCase{
		{`"Taipei".end_with?("1", "0", "1")`, "ArgumentError: Expect 1 argument(s). got: 3", 1, 1},
...
func TestStringEqualMethodFail(t *testing.T) {
	testsFail := []errorTestCase{
		{`"Hello".eql?`, "ArgumentError: Expect 1 argument(s). got: 0", 1, 1},
		{`"Hello".eql?("Hello", "World")`, "ArgumentError: Expect 1 argument(s). got: 2", 1, 1},
	}
...
func TestStringIncludeMethodFail(t *testing.T) {
	testsFail := []errorTestCase{
		{`"Goby".include?`, "ArgumentError: Expect 1 argument(s). got: 0", 1, 1},
		{`"Goby".include?("Ruby", "Lang")`, "ArgumentError: Expect 1 argument(s). got: 2", 1, 1},
...
func TestStringInsertMethodFail(t *testing.T) {
	testsFail := []errorTestCase{
		{`"Goby Lang".insert`, "ArgumentError: Expect 2 argument(s). got: 0", 1, 1},
		{`"Taipei".insert(6, " ", "101")`, "ArgumentError: Expect 2 argument(s). got: 3", 1, 1},
		{`"Taipei".insert("6", " 101")`, "TypeError: Expect argument #1 to be Integer. got: String", 1, 1},
		{`"Taipei".insert(6, 101)`, "TypeError: Expect argument #2 to be String. got: Integer", 1, 1},
...
func TestStringLeftJustifyMethodFail(t *testing.T) {
	testsFail := []errorTestCase{
		{`"Hello".ljust`, "ArgumentError: Expect 1 to 2 argument(s). got: 0", 1, 1},
		{`"Hello".ljust(1, 2, 3, 4, 5)`, "ArgumentError: Expect 1 to 2 argument(s). got: 5", 1, 1},
		{`"Hello".ljust(true)`, "TypeError: Expect argument #1 to be Integer. got: Boolean", 1, 1},
		{`"Hello".ljust("World")`, "TypeError: Expect argument #1 to be Integer. got: String", 1, 1},
		{`"Hello".ljust(2..5)`, "TypeError: Expect argument #1 to be Integer. got: Range", 1, 1},
		{`"Hello".ljust(10, 10)`, "TypeError: Expect argument #2 to be String. got: Integer", 1, 1},
		{`"Hello".ljust(10, 2..5)`, "TypeError: Expect argument #2 to be String. got: Range", 1, 1},
		{`"Hello".ljust(10, true)`, "TypeError: Expect argument #2 to be String. got: Boolean", 1, 1},
	}
...
func TestStringMatchFail(t *testing.T) {
	testsFail := []errorTestCase{
		{`'a'.match(Regexp.new("abc"), 1)`, "ArgumentError: Expect 1 argument(s). got: 2", 1, 1},
...
func TestStringReplaceMethodFail(t *testing.T) {
	testsFail := []errorTestCase{
		{`"Invalid".replace`, "ArgumentError: Expect 2 argument(s). got: 0", 1, 1},
		{`"Invalid".replace("string")`, "ArgumentError: Expect 2 argument(s). got: 1", 1, 1},
		{`"Invalid".replace("string", "replace", true)`, "ArgumentError: Expect 2 argument(s). got: 3", 1, 1},
		{`"Invalid".replace(true, "replacement")`, "TypeError: Expect argument #1 to be String or Regexp. got: Boolean", 1, 1},
		{`"Invalid".replace("pattern", true)`, "TypeError: Expect argument #2 to be String. got: Boolean", 1, 1},
	}
...
func TestStringReplaceOnceMethodFail(t *testing.T) {
	testsFail := []errorTestCase{
		{`"Invalid".replace_once`, "ArgumentError: Expect 2 argument(s). got: 0", 1, 1},
		{`"Invalid".replace_once("string")`, "ArgumentError: Expect 2 argument(s). got: 1", 1, 1},
		{`"Invalid".replace_once("string", "replace", true)`, "ArgumentError: Expect 2 argument(s). got: 3", 1, 1},
		{`"Invalid".replace_once(true, "replacement")`, "TypeError: Expect argument #1 to be String or Regexp. got: Boolean", 1, 1},
		{`"Invalid".replace_once("pattern", true)`, "TypeError: Expect argument #2 to be String. got: Boolean", 1, 1},
	}
...
func TestStringRightJustifyFail(t *testing.T) {
	testsFail := []errorTestCase{
		{`"Hello".rjust`, "ArgumentError: Expect 1 to 2 argument(s). got: 0", 1, 1},
		{`"Hello".rjust(1, 2, 3, 4, 5)`, "ArgumentError: Expect 1 to 2 argument(s). got: 5", 1, 1},
		{`"Hello".rjust(true)`, "TypeError: Expect argument #1 to be Integer. got: Boolean", 1, 1},
		{`"Hello".rjust("World")`, "TypeError: Expect argument #1 to be Integer. got: String", 1, 1},
		{`"Hello".rjust(2..5)`, "TypeError: Expect argument #1 to be Integer. got: Range", 1, 1},
		{`"Hello".rjust(10, 10)`, "TypeError: Expect argument #2 to be String. got: Integer", 1, 1},
		{`"Hello".rjust(10, 2..5)`, "TypeError: Expect argument #2 to be String. got: Range", 1, 1},
		{`"Hello".rjust(10, true)`, "TypeError: Expect argument #2 to be String. got: Boolean", 1, 1},
	}
...
func TestStringSliceMethodFail(t *testing.T) {
	testsFail := []errorTestCase{
		{`"Goby Lang".slice`, "ArgumentError: Expect 1 argument(s). got: 0", 1, 1},
		{`"Goby Lang".slice("Hello")`, "TypeError: Expect argument to be Range or Integer. got: String", 1, 1},
		{`"Goby Lang".slice(true)`, "TypeError: Expect argument to be Range or Integer. got: Boolean", 1, 1},
	}
...
func TestStringSplitMethodFail(t *testing.T) {
	testsFail := []errorTestCase{
		{`"Hello World".split`, "ArgumentError: Expect 1 argument(s). got: 0", 1, 1},
...
func TestStringStartWithMethodFail(t *testing.T) {
	testsFail := []errorTestCase{
		{`"Taipei".start_with("1", "0", "1")`, "ArgumentError: Expect 1 argument(s). got: 3", 1, 1},
...
func TestStringConversionFail(t *testing.T) {
	testsFail := []errorTestCase{
		{`"str".to_a(1)`, "ArgumentError: Expect 0 argument(s). got: 1", 1, 1},
		{`"str".to_d(1)`, "ArgumentError: Expect 0 argument(s). got: 1", 1, 1},
		{`"str".to_i(1)`, "ArgumentError: Expect 0 argument(s). got: 1", 1, 1},
		{`"str".to_f(1)`, "ArgumentError: Expect 0 argument(s). got: 1", 1, 1},
		{`"str".to_s(1)`, "ArgumentError: Expect 0 argument(s). got: 1", 1, 1},
		{`"1.1.1".to_f`, "ArgumentError: Invalid numeric string. got: 1.1.1", 1, 1},
		{`"3.5ef".to_f`, "ArgumentError: Invalid numeric string. got: 3.5ef", 1, 1},
	}
